    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Ведите адрес электронной почты', max_length=50, unique=True, verbose_name='Адрес электронной почты')),
                ('avatar', models.ImageField(blank=True, help_text='Выберите аватар', null=True, upload_to='users/', verbose_name='аватар')),
